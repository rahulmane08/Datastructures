...
public class PQUtils {
    ...
    static public void printStringWithNonRepeatingChars(String str) {
        ...
        java.util.PriorityQueue<Entry<Character, Integer>> pq = new java.util.PriorityQueue<>(
        ...
        for (Entry<Character, Integer> entry : charFreq.entrySet())
            pq.offer(entry);
        String output = "";
        Entry<Character, Integer> prevEntry = null;
        while (!pq.isEmpty()) {
            Entry<Character, Integer> currEntry = pq.poll();
