...
import static datastructures.list.ListUtils.ArrangementUtils.moveAllOccurencesOfKToEnd;
import static datastructures.list.ListUtils.ArrangementUtils.rearrageOddEvenTogether;
import static datastructures.list.ListUtils.ArrangementUtils.rearrangeInPlace;
import static datastructures.list.ListUtils.ArrangementUtils.reversePairs;
import static datastructures.list.ListUtils.ArrangementUtils.reversePairsRecursively;
import static datastructures.list.ListUtils.ArrangementUtils.rotateInBlocks;
import static datastructures.list.ListUtils.ArrangementUtils.rotateLeftBy;
import static datastructures.list.ListUtils.ArrangementUtils.rotateRightBy;
import static datastructures.list.ListUtils.InsertDeleteUtils.deleteAlternate;
import static datastructures.list.ListUtils.InsertDeleteUtils.deleteAlternateRecursive;
import static datastructures.list.ListUtils.InsertDeleteUtils.deleteDupesFromSortedList;
import static datastructures.list.ListUtils.InsertDeleteUtils.deleteIfRightIsHigher;
import static datastructures.list.ListUtils.InsertDeleteUtils.deleteIfRightIsHigherRecursive;
import static datastructures.list.ListUtils.InsertDeleteUtils.deleteLastOccurence;
import static datastructures.list.ListUtils.InsertDeleteUtils.deleteMiddle;
import static datastructures.list.ListUtils.InsertDeleteUtils.deleteNAfterMNodes;
import static datastructures.list.ListUtils.PalindromeUtils.checkIfListIsPalindrome;
import static datastructures.list.ListUtils.PalindromeUtils.lengthOfLargestPalindrome;
import static datastructures.list.ListUtils.SwapUtils.swap;
import static datastructures.list.ListUtils.areIdentical;
import static datastructures.list.ListUtils.containsSublist;
import static datastructures.list.ListUtils.flattenMultilevelList;
import static datastructures.list.ListUtils.flattenMultilevelListDepthWise;
import static datastructures.list.ListUtils.getMiddle;
import static datastructures.list.ListUtils.partitionlist;
import static datastructures.list.ListUtils.pointRandomToNextHigherNode;
import static datastructures.list.ListUtils.removeMiddlePoints;
...
import datastructures.list.ListUtils.ArrangementUtils.ReverseInGroupsOfKUtils;
import datastructures.list.ListUtils.Point;
