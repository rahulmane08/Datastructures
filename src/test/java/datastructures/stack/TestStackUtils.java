...
import static datastructures.stack.ExpressionUtils.maxDepthOfBalancedParentheses;
import static datastructures.stack.ExpressionUtils.maxLengthOfBalancedParentheses;
import static datastructures.stack.ExpressionUtils.removeBrackets;
import static datastructures.stack.StackUtils.checkPairWiseConsecutive;
import static datastructures.stack.StackUtils.countPatternOccurences;
import static datastructures.stack.StackUtils.countPatternOccurences1;
import static datastructures.stack.StackUtils.countPermutationsGreaterThanEqualToOriginalNumber;
import static datastructures.stack.StackUtils.decodeStringByCount;
import static datastructures.stack.StackUtils.deleteBottomKElements;
import static datastructures.stack.StackUtils.deleteMiddle;
import static datastructures.stack.StackUtils.findMinimumNumberForGivenSequence;
import static datastructures.stack.StackUtils.findNextGreaterOrSmallerElement;
import static datastructures.stack.StackUtils.findNextGreaterOrSmallerFrequencyElement;
import static datastructures.stack.StackUtils.maxHistogramArea;
import static datastructures.stack.StackUtils.minHistogramArea;
...
public class TestStackUtils {
  ...
  private final datastructures.stack.Stack<Integer> s = new Stack<>(10);
  ...
  public void test_stockSpan() {
    ...
    assertArrayEquals(span, expected);
  }
  ...
  public void test_findNextGreaterOrSmallerFrequencyElement() {
    assertArrayEquals(new int[] {-1, -1, 1, 2, 2, 1, -1},
