...
import static datastructures.tree.TreeUtils.CheckerUtils.areTreesIdentical;
import static datastructures.tree.TreeUtils.CheckerUtils.areTreesMirrors;
import static datastructures.tree.TreeUtils.CheckerUtils.checkIfSubTree;
import static datastructures.tree.TreeUtils.CheckerUtils.checkIfSumTree;
import static datastructures.tree.TreeUtils.PathQueryUtils.distanceBetweenAnyTwoNodes;
import static datastructures.tree.TreeUtils.PathQueryUtils.findLevelWithMaxSum;
import static datastructures.tree.TreeUtils.PathQueryUtils.printAllAncestors;
import static datastructures.tree.TreeUtils.PathQueryUtils.printAllLeaves;
import static datastructures.tree.TreeUtils.PathQueryUtils.printAllPathsMatchingSum;
import static datastructures.tree.TreeUtils.PathQueryUtils.printAllRootToLeafPaths;
import static datastructures.tree.TreeUtils.PathQueryUtils.printAncestorsOfGivenNode;
import static datastructures.tree.TreeUtils.PathQueryUtils.printFirstPathMatchingSum;
import static datastructures.tree.TreeUtils.PathQueryUtils.printFirstRootToLeafPath;
import static datastructures.tree.TreeUtils.PathQueryUtils.printKthLevelNodes;
import static datastructures.tree.TreeUtils.PrintUtils.printIn2DRotateLeftBy90;
import static datastructures.tree.TreeUtils.PrintUtils.printIn2DRotateLeftBy90Transpose;
import static datastructures.tree.TreeUtils.Traversals.diagonalTraversal;
import static datastructures.tree.TreeUtils.Traversals.diagonalTraversalIterative;
import static datastructures.tree.TreeUtils.Traversals.levelOrderTraversal;
import static datastructures.tree.TreeUtils.Traversals.preOrderTraversal;
import static datastructures.tree.TreeUtils.TreeSerializeDeserializeUtil.deserialize;
import static datastructures.tree.TreeUtils.TreeSerializeDeserializeUtil.serialize;
import static datastructures.tree.TreeUtils.ViewUtils.bottomView;
import static datastructures.tree.TreeUtils.ViewUtils.leftView;
import static datastructures.tree.TreeUtils.ViewUtils.rightView;
import static datastructures.tree.TreeUtils.ViewUtils.topView;
import static datastructures.tree.TreeUtils.addTrees;
import static datastructures.tree.TreeUtils.convertToSumTree1;
import static datastructures.tree.TreeUtils.countLeafNodes;
import static datastructures.tree.TreeUtils.countLeafNodesRecursively;
import static datastructures.tree.TreeUtils.exists;
import static datastructures.tree.TreeUtils.findMax;
import static datastructures.tree.TreeUtils.heightInterative;
import static datastructures.tree.TreeUtils.heightRecursive;
import static datastructures.tree.TreeUtils.image;
import static datastructures.tree.TreeUtils.lca;
import static datastructures.tree.TreeUtils.printVerticalSum;
import static datastructures.tree.TreeUtils.size;
import static datastructures.tree.TreeUtils.sizeIterative;
...
import datastructures.tree.TreeUtils.PathQueryUtils.MaxSumOfAnyPathUtil;
import datastructures.tree.TreeUtils.PathQueryUtils.MaxSumOfNonAdjacentNodesUtil;
import datastructures.tree.TreeUtils.PathQueryUtils.MaxSumOfRootToLeafPathsUtil;
import datastructures.tree.TreeUtils.PathQueryUtils.SumOfAllLeftLeafNodes;
import java.util.Arrays;
import java.util.List;
import java.util.Stack;
import leetcode.trees.medium.SumTreeChecker1;
...
public class TreeUtilsTest {
  ...
  public void test_PathWithMaxSumUtils() {
    ...
    assertNotEquals(0, pathWithMaxSumUtils.getMaxSum());
      assertFalse(pathWithMaxSumUtils.getPathWithMaxSum().isEmpty());
  ...
  public void testIfSumTree() {
    ...
    assertFalse(new SumTreeChecker1(bt.root).isCheck());
    ...
    assertTrue(new SumTreeChecker1(testTree.root).isCheck());
  }
  ...
  public void test_deepestNodesSum() {
    ...
    assertEquals(List.of(100), util.getDeepestNodes());
